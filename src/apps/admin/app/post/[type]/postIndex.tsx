    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-4xl font-bold">Todo: post type name</h1>
                <Button asChild><Link href={`/post/${type}/add`}>Add <CirclePlus className="h-5 w-5"/></Link></Button>
            </div>
